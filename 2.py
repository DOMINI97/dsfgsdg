...
def getUrl():
    url=''
    exeName = os.path.basename(sys.argv[0]).split('.')[0]
    if exeName=='1':
        url='https://www.adultdvdmarketplace.com/xcart/adult_dvd/modify_listings.php'
    elif exeName=='2':
        url='https://www.adultdvdmarketplace.com/xcart/adult_dvd/modify_listings.php?sort=&&page=301'
    elif exeName=='3':
        url='https://www.adultdvdmarketplace.com/xcart/adult_dvd/modify_listings.php?sort=&&page=601'
    elif exeName=='4':
        url='https://www.adultdvdmarketplace.com/xcart/adult_dvd/modify_listings.php?sort=&&page=901'
    return url
...
def updateListing(driver):
    ...
    isUpdated = False
    try:
        items = WebDriverWait(driver,100).until(EC.presence_of_all_elements_located((By.XPATH, '//form[@name="modifyform"]//tr')))
        for item in items:
            # print('for')
            try:
